...
class SearchPlaceViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        addressPassed = (currentCell.detailTextLabel!.text)!
        performSegue(withIdentifier: "unwind2Map", sender: currentCell)
